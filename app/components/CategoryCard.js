...
export default class CategoryCard extends Component {
	render() {
		...
		return (
			<TouchableOpacity
              style={{ justifyContent: 'center', alignItems:'center', margin: 10}}onPress={() => this.props.navigation.navigate('ActivityCategory', {item})}>
              <View style={{alignItems: 'center', justifyContent: 'center'}}>
                <Image source={{uri: item.imageurl}} style={{width:120, height:120, borderRadius: 0}}/>
